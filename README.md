...
The best gains that I found for my cost function were the following:

- Proportional Gain: -1.0784
- Integral Gain: -0.00694892
- Derivative Gain: -18.446

The proportional gain is the primary control mechanism used to generate a command which fights the error. The derivative gain is primarily used to damp overshoots, and the integral gain is used to remove steady-state error.
